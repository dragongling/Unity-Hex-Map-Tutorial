...
public class HexGridChunk : MonoBehaviour
{
    ...
    {
        bool hasRoadThroughTheEdge = cell.HasRoadThroughEdge(direction);
        ...
        TriangulateRoad(roadCenter, mL, mR, e, hasRoadThroughTheEdge);
        if (previousHasRiver)
        {
    ...
    private void TriangulateWithRiverBeginOrEnd(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        ...
        TriangulateRiverQuad(m.v2, m.v4, e.v2, e.v4, cell.RiverSurfaceY, 0.8f, reversed);
